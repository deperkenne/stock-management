...
export interface ContactInputProps extends ComponentPropsWithoutRef<'input'> {
  label: string;
  error?: string;
  id: string;
}
    ...
    return (
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={cn(
            'w-full rounded-lg border bg-slate-900/50 px-4 py-2.5 text-sm text-white placeholder-slate-500',
