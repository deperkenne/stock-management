...
// ─── Visual mockups (DRY: defined once, referenced in DEFAULT_FEATURES) ───────
...
function FeatureBlock({ icon, iconAccent = 'bg-indigo-500/10 text-indigo-400', title, description, visual, reversed = false }: Feature) {
  return (
